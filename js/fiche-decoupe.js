...
(function() {
  ...
  function ouvrirModal() {
    ...
    var estFourn = (fournisseur === 'dispano' || fournisseur === 'bouney' || fournisseur === 'eg_bois');
    ...
    document.getElementById('fd_fournisseur').addEventListener('change', function(e) {
      ...
      var est = (v === 'dispano' || v === 'bouney' || v === 'eg_bois');
  ...
  function injecterBouton() {
    ...
    bar.appendChild(btn);
    console.log('[fiche-decoupe v11] Bouton injecté (Dispano + Bouney + EG BOIS)');
  }
